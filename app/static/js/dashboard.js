...
function dashboard(initial) {
  ...
  return {
    ...
    get sortedWallPosts() {
      if (!this.wallSortCol) return this.wallPosts;
      const col = this.wallSortCol;
      const asc = this.wallSortAsc;
      return [...this.wallPosts].sort((a, b) => {
    ...
    // ── Table Helpers ──
    sortWall(col) {
      if (this.wallSortCol === col) {
        this.wallSortAsc = !this.wallSortAsc;
      } else {
        this.wallSortCol = col;
        this.wallSortAsc = false;
      }
    },
